...
# Dump of table PlantSensor
# ------------------------------------------------------------

DROP TABLE IF EXISTS `PlantSensor`;

CREATE TABLE `PlantSensor` (
...
LOCK TABLES `PlantSensor` WRITE;
/*!40000 ALTER TABLE `PlantSensor` DISABLE KEYS */;

INSERT INTO `PlantSensor` (`SEQ`, `DATETIME`, `TEMPERATURE`, `HUMIDITY`, `HI`)
VALUES
...
/*!40000 ALTER TABLE `PlantSensor` ENABLE KEYS */;
UNLOCK TABLES;
