...
public class Product{
	...
	private int plantNo;
	@Schema(description = "식물 등급 고유번호", example = "(1: Very Bad, 2: Bad, 3: Soso, 4: Good, 5: Very Good)", deprecated = false)
	private int plantScoreNo;
	@Schema(description = "화분 고유번호", example = "0", deprecated = false)
	private int warehousePlantNo;
	
	@Schema(description = "입찰 상품 명 (입력할 땐 사용하지않습니다.)", example = "스킨답서스", deprecated = false)
	...
	@Schema(description = "입찰 상태 - 입찰 완료 여부 (0: 삭제됨, 1: 입찰중, 2: 입찰완료)", example = "1", deprecated = true)
